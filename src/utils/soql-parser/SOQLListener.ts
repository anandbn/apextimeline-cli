...
export interface SOQLListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	enterSet_values_complex?: (ctx: Set_values_complexContext) => void;
	/**
	 * Exit a parse tree produced by `SOQLParser.set_values_complex`.
	 * @param ctx the parse tree
	 */
	exitSet_values_complex?: (ctx: Set_values_complexContext) => void;

	/**
	 * Enter a parse tree produced by `SOQLParser.set_values_variable`.
	 * @param ctx the parse tree
	 */
	enterSet_values_variable?: (ctx: Set_values_variableContext) => void;
	/**
	 * Exit a parse tree produced by `SOQLParser.set_values_variable`.
	 * @param ctx the parse tree
	 */
	exitSet_values_variable?: (ctx: Set_values_variableContext) => void;
