...
import { Set_values_complexContext } from "./SOQLParser";
import { Set_values_variableContext } from "./SOQLParser";
...
export interface SOQLVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by `SOQLParser.set_values_complex`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitSet_values_complex?: (ctx: Set_values_complexContext) => Result;

	/**
	 * Visit a parse tree produced by `SOQLParser.set_values_variable`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitSet_values_variable?: (ctx: Set_values_variableContext) => Result;
